<!DOCTYPE html>
<html lang="th" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('sneat-1.0.0/assets/') }}">
<head>
    <meta charset="utf-8">
    ...
    <style>body{font-family:'Public Sans','Noto Sans Thai',sans-serif}</style>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">{{ setting('site_name', 'University') }}</span>
                            </a>
                        </div>
                        <h4 class="mb-2">ยินดีต้อนรับ! 👋</h4>
                        <p class="mb-4">เข้าสู่ระบบเพื่อจัดการกิจกรรม</p>

                        <div id="login-error" class="alert alert-danger d-none" role="alert">
                            <span id="error-message"></span>
                        </div>

                        <form id="admin-login-form" class="mb-3" action="javascript:void(0);">
                            <div class="mb-3">
                                <label for="admin-email" class="form-label">อีเมล</label>
                                <input type="text" class="form-control" id="admin-email" name="email" placeholder="admin@example.com" autofocus>
                            </div>
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="admin-password" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember-email">จดจำอีเมล</label>
                                </div>
                            </div>
                        ...
                        <p class="text-center mt-2">
                            <a href="/"><i class="bx bx-arrow-back me-1"></i>กลับหน้าหลัก</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function () {
            ...
            $toggleBtn.on('click', function () {
                ...
                $toggleIcon.toggleClass('bx-hide', !isPassword).toggleClass('bx-show', isPassword);
            });

            $form.on('submit', function (e) {
                e.preventDefault();
                $btn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>กำลังเข้า...');
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        if (json.data && json.data.token) {
                            ...
                            $btn.html('กำลังนำคุณเข้าสู่ระบบ...');
                            setTimeout(function () {
            ...
            function showError(msg) {
                ...
                $btn.prop('disabled', false).html('<span class="btn-text">เข้าสู่ระบบ</span>');
            }
        });
    </script>
</body>
