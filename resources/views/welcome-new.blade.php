    ...
    <section class="relative min-h-[75vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50 pt-16">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6 py-16 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-12" style="animation: fadeUp .6s ease-out .4s backwards;">
                ...
                <a href="/login" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-indigo-600 bg-white border-2 border-indigo-100 rounded-full hover:border-indigo-200 hover:bg-indigo-50 transition-all no-underline">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto" style="animation: fadeUp .6s ease-out .5s backwards;">
                ...
                <a href="/activities" class="group bg-white border border-gray-100 rounded-2xl p-5 text-center hover:border-emerald-200 hover:shadow-lg hover:-translate-y-1 transition-all no-underline">
                    <div class="w-12 h-12 bg-emerald-50 text-emerald-500 rounded-xl flex items-center justify-center text-xl mb-3 group-hover:scale-110 transition-transform">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </div>
                ...
                <a href="/login" class="group bg-white border border-gray-100 rounded-2xl p-5 text-center hover:border-amber-200 hover:shadow-lg hover:-translate-y-1 transition-all no-underline">
                    <div class="w-12 h-12 bg-amber-50 text-amber-500 rounded-xl flex items-center justify-center text-xl mb-3 group-hover:scale-110 transition-transform">
                        <i class="fa-solid fa-user-tie"></i>
                    </div>
        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                <div class="text-center">
                    <div class="w-14 h-14 bg-indigo-50 text-indigo-500 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4">
                ...
                <div class="text-center">
                    <div class="w-14 h-14 bg-red-50 text-red-500 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4">
                ...
                <div class="text-center">
                    <div class="w-14 h-14 bg-emerald-50 text-emerald-500 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-4">
    ...
    <footer class="bg-gray-50 border-t border-gray-100 py-8 px-6">
        <div class="max-w-4xl mx-auto text-center">
            <div class="flex items-center justify-center gap-2 mb-3">
                <div class="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center text-white text-sm font-bold">
                    U
                </div>
