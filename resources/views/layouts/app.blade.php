<!DOCTYPE html>
<html lang="th" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('sneat-1.0.0/assets/') }}" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8">
    ...
    <style>body{font-family:'Public Sans','Noto Sans Thai',sans-serif}:root{--bs-font-sans-serif:'Public Sans','Noto Sans Thai',sans-serif}</style>
    @yield('style')
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">University</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ str_starts_with(request()->path(), 'admin/activities') ? 'active' : '' }}">
                        <a href="{{ route('admin.activities') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-calendar-event"></i>
                            <div>กิจกรรม</div>
                        </a>
                    </li>
                    <li class="menu-item {{ str_starts_with(request()->path(), 'admin/categories') ? 'active' : '' }}">
                        <a href="{{ route('admin.categories.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-category"></i>
                            <div>หมวดหมู่</div>
                        </a>
                    </li>
                    <li class="menu-item {{ str_starts_with(request()->path(), 'admin/reports') ? 'active' : '' }}">
                        <a href="/admin/reports" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-bar-chart-square"></i>
                            <div>รายงาน</div>
                        </a>
                    </li>
                    <li class="menu-item {{ str_starts_with(request()->path(), 'admin/settings') ? 'active' : '' }}">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <span class="avatar-initial rounded-circle bg-label-primary fw-bold">A</span>
                                    </div>
                                </a>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                &copy; <script>document.write(new Date().getFullYear());</script> University Activity System
                            </div>
                        </div>
                    </footer>
