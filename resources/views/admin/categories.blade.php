                ...
                var row = '<tr>' +
                    ...
                    '<td>' +
                        '<div style="display:flex;gap:0.5rem">' +
                            '<button class="btn btn-sm btn-secondary" onclick="openEditModal(' + cat.id + ',\'' + $('<span>').text(cat.name).html().replace(/'/g, "\\'") + '\',' + cat.status + ')" style="padding:0.375rem"><i class="fa-regular fa-pen-to-square"></i></button>' +
                            '<button class="btn btn-sm btn-secondary" onclick="deleteCategory(' + cat.id + ')" style="padding:0.375rem;color:var(--danger)"><i class="fa-regular fa-trash-can"></i></button>' +
                        '</div>' +
                    '</td>' +
                '</tr>';
